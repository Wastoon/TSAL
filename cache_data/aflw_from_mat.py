...
if __name__ == "__main__":
    ...
    for USE_BOX in USE_BOXES:
        save_to_list_file(allfaces, osp.join(SAVE_DIR, 'train.{}'.format(USE_BOX)), image_dir, annot_dir,
                          aflwinfo['train-index'], False, USE_BOX)
        save_to_list_file(allfaces, osp.join(SAVE_DIR, 'test.{}'.format(USE_BOX)), image_dir, annot_dir,
                          aflwinfo['test-index'], False, USE_BOX)
        save_to_list_file(allfaces, osp.join(SAVE_DIR, 'test.front.{}'.format(USE_BOX)), image_dir, annot_dir,
                          aflwinfo['test-index'], True, USE_BOX)
        save_to_list_file(allfaces, osp.join(SAVE_DIR, 'all.{}'.format(USE_BOX)), image_dir, annot_dir,
                          aflwinfo['train-index'] + aflwinfo['test-index'], False, USE_BOX)
